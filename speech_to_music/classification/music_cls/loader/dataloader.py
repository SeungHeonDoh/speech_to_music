...
from speech_to_music.classification.music_cls.loader.dataset import Emotion_Dataset

class DataPipeline(LightningDataModule):
    def __init__(self, data_type, batch_size, num_workers) -> None:
    ...
    @classmethod
    def get_dataset(cls, dataset_builder: Callable, split, data_type) -> Dataset:
        dataset = dataset_builder(split, data_type)
        return dataset
