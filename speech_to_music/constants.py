...
IEMOCAP_ORIGIN_TAGS = ["ang","exc","fru","hap","neu","sad"]
IEMOCAP_TAGS = ["angry","happy","neutral","sad"]
# IEMOCAP_SUBTAGS = ["neutral","happy","angry","sad"]
RAVDESS_TAGS = ['angry', 'disgust', 'fearful', 'happy', 'neutral', 'sad', 'surprised']
EMOFILM_TAGS = ['fear','disgust','happy','anger','sad']
IEMOCAP_MAP = {"e0":"neutral", "e1":"happy", "e2":"angry", "e3":"sad"}
IEMOCAP_TAGMAP = {"neu":"neutral","hap":"happy","ang":"angry","sad":"sad", "exc":"happy"}
